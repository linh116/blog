	...
	class Fusion_Column_Element extends Fusion_Element {
		...
		public function render( $atts, $content = '' ) {
			...
			if ( isset( $this->args['background_data'] ) && is_array( $this->args['background_data'] ) ) {
				$placeholder_img_h = $this->args['background_data']['height'];
				$placeholder_img_w = $this->args['background_data']['width'];
				$placeholder_img   = sprintf( '<img src="%s" alt="">', call_user_func_array( [ fusion_library()->images, 'get_lazy_placeholder' ], [ $placeholder_img_w, $placeholder_img_h ] ) );
			}
			$this->args['empty_column_bg_img'] = empty( $column_content ) && isset( $this->args['background_data'] ) && is_array( $this->args['background_data'] ) ? true : false;
